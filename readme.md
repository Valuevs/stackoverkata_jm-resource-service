...
# Как настроить 2 профиля и переключаться между ними

## Профили

Создайте файлы конфигурации для каждого профиля в пакете "resources":
...
## Запуск приложения
Теперь можно запустить приложение, и оно будет использовать указанные переменные окружения.